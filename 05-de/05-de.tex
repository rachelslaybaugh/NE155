...
\begin{document}
\begin{center}
{\bf NE 155, Classes 5-6, S16 \\
Diffusion Equation \\ January 29 -- February 1, 2016}
\end{center}
...
These aren't quite so simple. We start by thinking about a non-reentrant condition for the TE: 
\[\psi(\vec{r}_s, \vOmega, t) = 0 \text{ for } \vOmega \cdot \hat{e}_s < 0 \:,\]
%
which is a mathematical statement that there are no neutrons entering our volume. This is the same as saying
