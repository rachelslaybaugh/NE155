...
%
S_6+S_7 &= \boxed{\frac{\phi_{i,j+1} - \phi_{i,j}}{\epsilon_{j+1}} \biggl(\frac{D_{i,j+1} \delta_{i} + D_{i+1,j+1} \delta_{i+1}}{2}\biggr)}\:,\\
%
S_1+S_8 &= \boxed{\frac{\phi_{i-1,j} - \phi_{i,j}}{\delta_{i}} \biggl(\frac{D_{i,j} \epsilon_{j} + D_{i,j+1} \epsilon_{j+1}}{2}\biggr)}\:,\\
%
S_4+S_5 &= \boxed{\frac{\phi_{i+1,j} - \phi_{i,j}}{\delta_{i+1}} \biggl(\frac{D_{i+1,j} \epsilon_{j} + D_{i+1,j+1} \epsilon_{j+1}}{2}\biggr)}\:,
\end{align*}
%
