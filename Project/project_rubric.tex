...
The final paper should be $\sim$6-7 pages with \textbf{1.5 spacing} per team member. This may vary based on the specific project; please use your best judgment. 

\vspace*{1em}
\underline{\textbf{Final report}}: Please include these items as clearly labeled sections
%
\begin{enumerate}
