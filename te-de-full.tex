...
\begin{document}
\begin{center}
{\bf NE 155, Classes 4-8, S16 \\
TE and DE \\ January 27 -- February 5, 2016}
\end{center}
...
\begin{figure}[h!]
    \begin{center}
    \includegraphics[keepaspectratio, width = 2.7 in]{04-te/phase_space}
    \end{center}
...
\includegraphics[height=1in]{05-de/DifferentialArea}
\end{center}
\end{figure}
...
\begin{figure}[H]
\includegraphics[height=2in]{05-de/InterfaceCondition}
...
\begin{minipage}{0.45\textwidth}
\begin{figure}[H]
\includegraphics[height=1.75in]{05-de/FreeSurfaceCondition}
...
Use the polynomials as follows and take the first two terms of the expansion:
\begin{align*}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[height=3 in]{05-de/DiffusionBC}
\end{center}
\end{figure}
