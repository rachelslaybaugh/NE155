...
\vspace*{2em}
Please include these same items in your \underline{final presentation}. For projects with one person, aim for 10 minutes and projects with two people aim for 15 minutes. 
...
Explanation of work is understandable, correct, and supports the motivation & 8 & \\ \hline
Results and conclusions are clearly communicated & 7 & \\ \hline
Good presentation skills: eye contact, volume, clarity of slides, etc. & 8 & \\ \hline
Appropriate presentation length & 4 & \\ \hline
Total & 50 & \\\hline
\end{tabu} 
\end{center}
