...
\item \textbf{Heterogeneous} architecture: GPUs + CPUs
\item Look back at that top 10 list...
\end{itemize}
\end{frame}
...
\begin{center}
\includegraphics[height=2.25in]{road-not-taken2}
\end{center}
\end{frame}
