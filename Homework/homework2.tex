...
\begin{equation}
\vec{x}_{\lambda =3} = \begin{pmatrix} 1 \\ -1 \end{pmatrix} \qquad
...
%
\begin{equation}
\vec{x}_{\lambda =3} = \begin{pmatrix} 0 \\ 0 \\ 1 \end{pmatrix} \qquad
...
%
\begin{equation}
\vec{x}_{\lambda =4} = \begin{pmatrix} 0 \\ 1 \\ 2 \end{pmatrix} \qquad
