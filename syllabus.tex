...
\begin{itemize}
  ...
  \item Software Carpentry has lots of useful lessons: \href{http://software-carpentry.org/lessons.html}{http://software-carpentry.org/lessons.html}
...
\begin{tabu}{| c | l | X | c | c |}
    \multicolumn{1}{c}{Lecture} & \multicolumn{1}{c}{Date} & \multicolumn{1}{c}{Topic} & \multicolumn{1}{c}{Assigned} & \multicolumn{1}{c}{Due} \\
    \hline
    1     & 21-Jan & intro, organization, intro to computing & hw 1  &  \\
    2     & 23-Feb & parallelization; types of equations &       & hw 1 \\
    3     & 26-Jan & solution method overview &       &  \\
    ...
    19    & 6-Mar & 1-D finite diff intro &       &  \\
...
\hline
    ...
    34    & 17-Apr & Monte Carlo statiscs &       &  \\
    ...
    final & 12-May & Final reports; 7-10 pm &       &  \\
\hline
\end{tabu}%

%\begin{tabu}{| c | l | X | c | c |}\hline
%\csvreader{2015CourseSchedule.csv}{}\\
%\hline
%\end{tabu}
