...
\hline
4 & Jan 29 & Intro to nuclear reactor modelling and simulation & \\
\hline
% word wrap
& & Types of differential and integral equations & \\ [-1ex]
\raisebox{1.5ex}{5} & \raisebox{1.5ex}{Jan 31} & in radiation transport & \\
\hline
6 & Feb 3 & Fundamentals of numerical methods - matrix algebra & \\
\hline
% word wrap
& & Vector and matrix norms; eigenvalues and eigenvectors of a matrix; & \\ [-1ex]
\raisebox{1.5ex}{7} & \raisebox{1.5ex}{Feb 5} & spectral radius of a matrix & 1 \\
\hline 
...
15 & Feb 26 & Intro to the finite volume method for 1-D diffusion & \\
 \hline 
16 & Mar 1 & Fixed-source problems using finitie differenc and finitie volume methods & \\
\hline 
17 & Mar 3 & Eigenvalue problems using finitie differenc and finitie volume methods & \\
\hline 
