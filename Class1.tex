...
\end{itemize}
\item However, modelling was severely constrained 
...
\item Inaccuracy resulted in significant design margins $\rightarrow$ negative impact on plant economics
...
\item Lets us reduce margins, extend existing reactor lifetimes, and consider new designs.
\end{itemize}
\begin{figure}
