...
How do we develop an algorithm to execute this that can be easily programmed? Let's start by writing our system this way:
%
\begin{equation}
\begin{pmatrix}
B_0  & -C_0 & 0    & 0    & \cdots & 0 \\
...
The generalized algorithm is short and easy, so I'll just write it out
%
\begin{enumerate}
