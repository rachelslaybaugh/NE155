...
\begin{document}
\begin{center}
{\bf NE 155, Classes 23-24, S14 \\
Finite Difference Methods for the eigenvalue form of the DE \\ March 17 \& 21, 2014}
\end{center}
...
\bigg|\frac{\phi_i^{(n)} - \phi_i^{(m-1)}}{\phi_i^{(m)}}\bigg| &< \epsilon_2 \nonumber
\end{align}
%
...
Note: this applies in our formulation when $\ve{B} \equiv \ve{A}^{-1}\ve{F}$, $\lambda \equiv k$ and $\vec{x} \equiv \vec{\phi}$. 
