...
representations of physics
    ...
    \item Distinguish between a \textit{discrete} PDF/CDF and \\ a \textit{continuous} PDF/CDF
...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}
  	\begin{figure}
  	\begin{center}
  		\includegraphics[height=1.5in,clip]{../figs/unif-dist-var}
	\end{center}
  	\end{figure}
  \end{column}
\end{columns}
...
Sampling Procedure
    ...
    \end{itemize}
  	...
  	\begin{figure}
  	\begin{center}
  		\includegraphics<1>[height=1.5in,clip]{../figs/disc-pdf}
  		\includegraphics<2>[height=1.5in,clip]{../figs/disc-pdf-samp}
	\end{center}
  	\end{figure}
...
Consider the CDF
  	...
  	\begin{figure}
  	\begin{center}
  		\includegraphics[height=2.5in,clip]{../figs/disc-cdf}
	\end{center}
  	\end{figure}
...
\begin{frame}{Direct Continuous Sampling}
    ...
    \hspace*{3 em} Generate $\xi$ , \hspace*{1 em} Determine $x = P^{-1}(\xi)$
  	\begin{figure}
  	\begin{center}
  		\includegraphics<1>[height=1.5in,clip]{../figs/cont-pdf}
  		\includegraphics<2>[height=1.5in,clip]{../figs/cont-cdf-on-pdf}
  		\includegraphics<3>[height=1.5in,clip]{../figs/cont-cdf-on-pdf-grey}
	\end{center}
  	\end{figure}    
...
\[
  ...
  \action<+->{G(t) &= \int_{-\infty}^t g(t')dt' = \int_0^t g(t') dt' = \biggl[- \frac{e^{-\lambda t'}}{\lambda} \biggr]_0^t = \frac{1}{\lambda} \bigl(1 - e^{-\lambda t}\bigr)\\
    ...
    %
    P(t) &= \int_{-\infty}^t p(t')dt' = \int_0^t \lambda g(t') dt' = \bigl[e^{-\lambda t'} \bigr]_0^t = 1 - e^{-\lambda t}\\
    %
    P(\infty) &= 1}
  \end{aligned}
\]    
...
\begin{frame}{Rejection Sampling}
  	...
  	\begin{figure}
  	\begin{center}
  		\includegraphics<1>[height=2.5in,clip]{../figs/rej-samp1}
  		\includegraphics<2>[height=2.5in,clip]{../figs/rej-samp2}
  		\includegraphics<3>[height=2.5in,clip]{../figs/rej-samp3}
  		\includegraphics<4>[height=2.5in,clip]{../figs/rej-samp4}
	\end{center}
  	\end{figure} 
