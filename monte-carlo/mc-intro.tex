...
\begin{itemize}
\item Applications that are mathematically equivalent to integration over many dimensions.
\begin{itemize}
...
\end{itemize} 
\item However, statistically accurate results can require significant computer time
\item Monte Carlo and parallel computing go well together
\end{itemize}
